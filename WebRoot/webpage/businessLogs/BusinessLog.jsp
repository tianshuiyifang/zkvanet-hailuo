				...
				<div class="row">
					<div class="customer-leftsidebar p-lr15 p-t15">
						<div class="auto-high row bc-fff  side-left">
							<div class="side-subtitle" title="日志类型">
								<b>日志类型</b>
							</div>
							<div class="side-busines account-side-busines p-tb10">
								<ul class="tab-nav" id="tab_nav">
									
									<li id="businessLogs"><a style="outline-style: none;">业务日志</a></li>
									<li id="loginLogs"><a style="outline-style: none;">登录日志</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="customer-rightsidebar p-15">
						...
						<div class="tab-con-business b1-ccc bc-fff dn">
							<div class="main-tab">
								<div class="tab-navbar">
									<ul class="js-business-tab-nav tab-nav tab-auto-nav clearfix" id="tab_nav_business">
										<li class="active" value="1" ><a class="cp">设备管理</a></li>
										<li  value="2" ><a class="cp">客户管理</a></li>
									</ul>
								</div>								
								<div class="tab-con" id="tab_con_business">
									<div class="consumption-con-box">
										<div class="funcbar clearfix">
											<form class="form-inline search-criteria clearfix p-tb10">
												<div class="form-group fl">
													<div class="btn-group btn-group-sm button_xf " id="devDiv">
														<button class="btn btn-default btn-primary" type="button" value="5" title="<">
															<span class="c-00a0ea"></span>&nbsp;分配 
														</button>
														<button class="btn btn-default" type="button" value="1" >
															<span class="c-00a0ea"></span>&nbsp;修改
														</button>
													</div>  
												</div>
												...
												<div class="form-group fr">
													<div class="input-group input-group-sm">
														<input type="text" class="form-control form-sm form-search" id="selectUserName_xf" title="请输入操作人/目标账号/IMEI号搜索" placeholder="请输入操作人/目标账号/IMEI号搜索" size="30">
														<span class="input-group-btn">
															<button class="btn btn-primary" type="button" id="search_xf"><i class="fa fa-search"></i>&nbsp;搜索</button>
														</span>
													</div>
												</div>
												<div class="form-group fr p-r15">												
													<input type="text" id="createTimeStart_xf" readonly="readonly" class="form-control form-control-sm"  title="开始时间" placeholder="开始时间" size="16"/>												
													<input type="text" id="createTimeEnd_xf" readonly="readonly" class="form-control form-control-sm"  title="结束时间" placeholder="结束时间" size="16"/>														
												</div>
											</form>
										</div>
										<div class="table-header">
											<table id="consumptionTableHeader" class="table table-hover table-ellipsis m-b0">
												<thead>
													<tr>
														<th>操作人</th>
														<th>创建时间</th>
										...
										<div class="table-scrollbar oy-a">
											<table id="consumptionTableContent" class="table table-hover table-ellipsis">
												<colgroup>
													<col>
													<col>
													<col>
												...
												<tbody id="logslist_xf">
												</tbody>
											</table>
											<div id="paging_xf" class="simple-pagination-custom ta-c"></div>
											<div id="markNull_xf" style="display: none;">
												<div class="ta-c c-666 p-tb10">
													<span class="p-5 d-ib">&nbsp;<i class="fa fa-bell-o"></i> 暂无数据&nbsp;
													</span>
												</div>
											</div>
											<div id="noData_xf" style="display: none;"><div class="ta-c c-666 p-tb10"><span class="p-5 d-ib">&nbsp;<i class="fa fa-bell-o"></i> 暂无数据&nbsp;</span></div></div>
											<div class="ta-c m-tb15" id="logindata_xf"><i class="fa fa-spinner fa-pulse fa-fw"></i>正在加载数据...</div>
										</div>
									</div>
									<div class="allocation-con-box">
										<div class="funcbar clearfix">
											<form class="form-inline search-criteria clearfix p-tb10">
												<div class="form-group fl">
													<div id="custDiv" class="btn-group btn-group-sm button_xf ">
														<button class="btn btn-default btn-primary" type="button" value="1" >
															<span class="c-00a0ea"></span>&nbsp;修改
														</button>
														<button class="btn btn-default" type="button" value="0" >
															<span class="c-00a0ea"></span>&nbsp;添加
														</button>
														<button class="btn btn-default" type="button" value="2" >
															<span class="c-00a0ea"></span>&nbsp;删除
														</button>
														<button class="btn btn-default" type="button" value="3" >
															<span class="c-00a0ea"></span>&nbsp;修改密码
														</button>
														<button class="btn btn-default" type="button" value="4" >
															<span class="c-00a0ea"></span>&nbsp;重置密码
														</button>
													</div>
												</div>
												<div class="form-group fr ">
													<div class="input-group input-group-sm">
														<input type="text" class="form-control form-search" id="selectUserName_fp"  title="请输入账号" placeholder="请输入账号" size="30">
														<span class="input-group-btn">
															<button class="btn btn-primary" type="button" id="search_fp"><i class="fa fa-search"></i>&nbsp;搜索</button>
														</span>
													</div>
												</div>
												<div class="form-group fr p-r15">
													<input type="text" id="createTimeStart_fp" readonly="readonly" class="form-control form-control-sm"  title="开始时间" placeholder="开始时间" size="16"/>
													<input type="text" id="createTimeEnd_fp" readonly="readonly" class="form-control form-control-sm"  title="结束时间" placeholder="结束时间"  size="16"/>
												</div>
										...
										<div class="table-header">
											<table id="allocationTableHeader" class="table table-hover table-ellipsis m-b0">
												<thead>
													<tr>
														<th>操作人</th>
														<th>创建时间</th>
										...
										<div class="table-scrollbar oy-a">
											<table id="allocationTableContent" class="table table-hover table-ellipsis">
												<colgroup>
													<col>
													<col>
													<col>
												...
												<tbody id="logslist_fp">
			
												</tbody>
											</table>
											<div id="paging_fp" class="simple-pagination-custom ta-c"></div>
		
											<div id="markNull_fp" style="display: none;">
												<div class="ta-c c-666 p-tb10">
													<span class="p-5 d-ib">&nbsp;<i class="fa fa-bell-o"></i> 暂无数据&nbsp;
													</span>
												</div>
											</div>
											<div id="noData_fp" style="display: none;"><div class="ta-c c-666 p-tb10"><span class="p-5 d-ib">&nbsp;<i class="fa fa-bell-o"></i> 暂无数据&nbsp;</span></div></div>
											<div class="ta-c m-tb15" id="logindata_fp"><i class="fa fa-spinner fa-pulse fa-fw"></i>正在加载数据...</div>
										</div>
								</div>
							</div>
					...
					<!-- -------------------------------------- -->
					<div class="tab-con-command b1-ccc bc-fff dn">
							<div class="main-tab">
								<div class="tab-navbar">
									<ul class="js-command-tab-nav tab-nav tab-auto-nav clearfix">
										<li class="active" title="登录日志"><a onclick="queryBusinessLog('offline','1');" class="cp">登录日志</a></li>
									</ul> 
								</div>
								<div class="tab-con" id="tab_con_command">
									<div class="offline-command-con-box" style="display: block;">
											...
											<form class="form-inline search-criteria clearfix p-tb10">
												...
												<div class="form-group fr">
													<div class="input-group">
														<div class="form-group">
															<input type="text" value="" name="loginAccount" class="form-control form-control-sm" id="loginAccount_sport" placeholder="账号" title="账号"/>
														</div>
														&nbsp;&nbsp;
														<div class="form-group">
															
															<input type="text" value="" name="startTime" class="form-control form-control-sm" id="startTime_sport" placeholder="开始时间" title="开始时间"/>
														</div>
														&nbsp;
														<div class="form-group">
														...
														<span class="input-group-btn">
															<button onclick="searchlogslist_log();" type="button"
										...
										<div class="table-header">
											<table class="table table-hover table-ellipsis m-b0">
												<thead>
													<tr>
														<th title="序号">序号</th>
														<th title="登录源">登录源</th>
										...
										<div class="table-scrollbar oy-a">
											<table id="loginLogTableContent" class="table table-hover table-ellipsis">
												
												<tbody id="loginLog-tbody">
													
												</tbody>
												
												<script type="text/html" id="loginLog-logs">
														{{each result as tm i }}
															<tr>
																<td title="{{(pageNo-1)*pageSize+(i+1)}}">
																	{{(pageNo-1)*pageSize+(i+1)}}
																</td>	
											                	<td title="{{tm.loginType}}">{{tm.loginType}}</td>
											                	<td title="{{tm.loginAccount}}">{{tm.loginAccount}}</td>
											                	<td title="{{tm.loginIP}}">{{tm.loginIP}}</td>
											                	<td title="{{tm.loginTime}}">{{tm.loginTime}}</td>
											                	<td title="{{tm.loginMsg}}">{{tm.loginMsg}}</td>
										              		</tr>
														{{/each}}
										        	</script>
											</table>
											
											<div id="paging_login_log" class="simple-pagination-custom ta-c"></div>
											
											<div id="noData_log" style="display: none;"><div class="ta-c c-666 p-tb10"><span class="p-5 d-ib">&nbsp;<i class="fa fa-bell-o"></i> 暂无数据&nbsp;</span></div></div>
											<div class="ta-c m-tb15 dn" id="logindata_log"><i class="fa fa-spinner fa-pulse fa-fw"></i>正在加载数据...</div>
...
<script src="webpage/resource/plugins/photobox/jquery.photobox.js"></script> 
	...
	<script>
	 $(function(){
			//切换一级tab;
			$("#tab_nav_business li").click(function() {
				initXfFpTime();
				if($(this).val()==1){
					$('#devDiv button').removeClass('btn-primary');
					$('#devDiv button:eq(0)').addClass('btn-primary');
					$("#selectUserName_xf").val("");
					getServiceLog(1,5);
				}else{
					$("#custDiv button").removeClass('btn-primary');
					$('#custDiv button:eq(0)').addClass('btn-primary');
					$("#selectUserName_fp").val("");
					getServiceLog(2,1);
				}
			});
			//切换二级tab;
			$("#devDiv button").click(function() {
				getServiceLog(1,$(this).val());
			});
			$("#custDiv button").click(function() {
				getServiceLog(2,$(this).val());
			});
			
			$("#search_xf").click(function() {
				if($("#createTimeStart_xf").val() && $("#createTimeEnd_xf").val()){
					if(new Date($("#createTimeStart_xf").val()).getTime() > new Date($("#createTimeEnd_xf").val()).getTime()){
						layer.msg($.i18n.prop("comm.StarttimegtEndtime"));
						return ;
					}
				}
				pageNo_xf=1;
				getServiceLog(serviceType,operType);
			});
			$("#search_fp").click(function() {
				if($("#createTimeStart_fp").val() && $("#createTimeEnd_fp").val()){
					if(new Date($("#createTimeStart_fp").val()).getTime() > new Date($("#createTimeEnd_fp").val()).getTime()){
						layer.msg($.i18n.prop("comm.StarttimegtEndtime"));
						return ;
					}
				}
		...
		var serviceType=1;//业务类型：0.其他 1.设备 2.客户
		var operType=1;//操作类型：0.新增 1.更新 2.删除 3.密码修改 4.密码重置 5.设备分配
		function getServiceLog(serType,opType) {
			...
			var param = {serviceType:serviceType,operType:operType};
			if(param.serviceType==1){
				initlogslist_xf(param);
			}else{
				initlogslist_fp(param);
			}
		}
		function initlogslist_fp(param) {
			$('#markNull_fp').hide();
			$('#paging_fp').hide();
			$('#logindata_fp').show();
			$('#noData_fp').hide();
			$('#allocationTableContent').hide();
			param.createTimeStart=$("#createTimeStart_fp").val();
			param.createTimeEnd=$("#createTimeEnd_fp").val();
			param.selectUserName=$("#selectUserName_fp").val();
			param.pageSize = pageSize_fp;
			param.currentPage = pageNo_fp;
			
			$.ajax({
				type : 'POST',
				url : _ctx + "/business/businessLogs/getServiceLog",
				async : true,
				cache : false,
				data : param,
				success : function(returnData) {
					if(returnData&&returnData.data&&returnData.data.result.length>0){
						var datas = returnData.data;
						if (datas.result && datas.result.length) {
							$.each(datas.result,function(i,v){
								if(param.serviceType==2){
									v.imei=v.account;
								}
								if(v.operType== 0 ){
									v.remarks='添加'
								}else if(v.operType== 1 ){
									v.remarks='修改'
								}else if(v.operType== 2 ){
									v.remarks='删除'
								}else if(v.operType== 3 ){
									v.remarks='修改密码'
								}else if(v.operType== 4 ){
									v.remarks='重置密码'
								}else if(v.operType== 5 ){
									v.remarks='分配'
								}
							});
							$('#paging_fp').show();
						...
						if (returnData.code == 0) {
							$('#logslist_fp').html(template('v-info-fp', datas));
						}
						totalRecord_fp = datas.totalRecord;
						$('#logindata_fp').hide();
						$('#noData_fp').hide();
						$('#allocationTableContent').show();
						tableHeaderAutoWidth("#allocationTableHeader","#allocationTableContent");//分配表头自动宽度
						if(isOneClick_fp = 1){
							initpaging_fp(param);
						}
					}else{
		...
		function initlogslist_xf(param) {
			$('#markNull_xf').hide();
			$('#paging_xf').hide();
			$('#logindata_xf').show();
			$('#noData_xf').hide();
			$('#consumptionTableContent').hide();
			param.createTimeStart=$("#createTimeStart_xf").val();
			param.createTimeEnd=$("#createTimeEnd_xf").val();
			param.selectUserName=$("#selectUserName_xf").val();
			param.pageSize  = pageSize_xf;
			param.currentPage = pageNo_xf;
				...
				success : function(returnData) {
					if(returnData&&returnData.data&&returnData.data.result.length>0){
						...
						if (datas.result && datas.result.length) {
							$.each(datas.result,function(i,v){
								if(v.operType== 1 ){
									v.remarks ="{0} 修改 {1}的设备  {2} 信息".replace("{0}",v.createdAccount).replace("{1}",v.account).replace("{2}",v.imei);
								}else if(v.operType== 5 ){
									v.remarks ="{0} 将 {1} 分给 {2}".replace("{0}",v.createdAccount).replace("{1}",v.imei).replace("{2}",v.account);
								}
							});
							$('#paging_xf').show();
						} else {
						...
						if (returnData.code == 0) {
							$('#logslist_xf').html(template('v-info-xf', datas));
						}
						totalRecord_xf = datas.totalRecord;
						$('#logindata_xf').hide();
						$('#noData_xf').hide();
						$('#consumptionTableContent').show();
						tableHeaderAutoWidth("#consumptionTableHeader","#consumptionTableContent");//消费表头自动宽度
						if(isOneClick_xf = 1){
							initpaging_xf(param);
							isOneClick_xf=0;
						}
  ...
  (function($){
    ...
    //指令头部自动宽度
    function commandTableHeaderAutoWidth(){
      tableHeaderAutoWidth("#offlineCommandTableHeader","#offlineCommandTableContent");//离线表头
      tableHeaderAutoWidth("#commandLogTableHeader","#commandLogTableContent");//指令日志表头
    }

    //指令表格高度
    function commandTableHeight(){
    	 tableHeight(".tab-con-command",".offline-command-con-box");//离线指令表格
         tableHeight(".tab-con-command",".command-log-con-box");//指令日志表格
    }
    
  	//指令日志选项卡
    tabs(".js-command-tab-nav","active","#tab_con_command",function(){
    	commandTableHeight();
       	commandTableHeaderAutoWidth();
     });
    
  	
  	//业务头部自动宽度
    function businessTableHeaderAutoWidth(){
      tableHeaderAutoWidth("#allocationTableHeader","#allocationTableContent");//分配表头
      tableHeaderAutoWidth("#consumptionTableHeader","#consumptionTableContent");//消费表头
      tableHeaderAutoWidth("#operationTableHeader","#operationTableContent");//操作表头
    }
  	
    //业务表格高度
    function businessTableHeight(){
    	 tableHeight(".tab-con-business",".allocation-con-box");//分配表格高度
         tableHeight(".tab-con-business",".consumption-con-box");//指令日志表格高度
         tableHeight(".tab-con-business",".operation-con-box");//操作日志表格高度
         
    }
    
  	//业务日志选项卡
    tabs(".js-business-tab-nav","active","#tab_con_business",function(){
    	businessTableHeight();
    	businessTableHeaderAutoWidth();
     });
    
    //左侧选项卡
    tabs(".side-busines #tab_nav","active",".customer-rightsidebar",function(){
    	commandTableHeight();
    	businessTableHeight();
        commandTableHeaderAutoWidth();
        businessTableHeaderAutoWidth();
	...
	//单选框、复选框
	$("#offlineCommandTableHeader input[type = 'checkbox'],#offlineCommandTableHeader input[type = 'radio']").iCheck();
	...
	$(function(){
		...
		$("#businessLogs").click();
		//queryBusinessLog('offline','1');
		
	});
	
	var totalRecord_log_offline = 30;
	var pageNo_log_offline = 1;
	var pageSize_log_offline = 10;
	function initOffLinelogsPagination(offLineParam){
		$("#paging-offline").pagination({
			prevText : "上一页",
			nextText : "下一页",
			items : totalRecord_log_offline,
			itemsOnPage : pageSize_log_offline,
			cssStyle: 'light-theme',
			param : offLineParam,
			onPageClick : function(pageNumber,pageSize,param, event) {
				if(event && (event.type=="click" || event.type=="change")){
					pageNo_log_offline = pageNumber;
					pageSize_log_offline = pageSize;
					queryBusinessLog("offline",'0',param);
				}
			},
			onInit : function() {
				$("#paging-offline").pagination("selectPage", pageNo_log_offline);
			}
		});
	}
	
	var totalRecord_log_command = 30;
	var pageNo_log_command = 1;
	var pageSize_log_command = 10;
	function initCommandlogsPagination(commandParam){
		$("#paging-command").pagination({
			prevText : "上一页",
			nextText : "下一页",
			items : totalRecord_log_command,
			itemsOnPage : pageSize_log_command,
			cssStyle: 'light-theme',
			param : commandParam,
			onPageClick : function(pageNumber,pageSize,param, event) {
				if(event && (event.type=="click" || event.type=="change")){
					pageNo_log_command = pageNumber;
					pageSize_log_command = pageSize;
					queryBusinessLog("command",'0',param);
				}
			},
			onInit : function() {
				$("#paging-command").pagination("selectPage", pageNo_log_command);
			}
		});
	}
	
	//queryFlag ： offline离线指令    command指令日志
	function queryBusinessLog(queryFlag,clickTye,param){
		var isOffLine = "";
		var isExecute = "";
		var queryCondition = "";
		if(!param){
			if(queryFlag == "offline"){
				if(clickTye == "1"){
					$("button[name='searchBtn-type']").eq(0).addClass("btn-primary").siblings().removeClass("btn-primary");
					offline_flag = "";
				}
				isOffLine = "1";
				command_line_flag = "";
				command_status_flag = "";
				if(offline_flag == "offline_cancel"){//已取消
					isExecute = "4";
				}else if(offline_flag == "offline_toSend"){//待发送
					isExecute = "3";
				}
				queryCondition = {
					"currentPage" : pageNo_log_offline,
					"pageSize": pageSize_log_offline,
					"condition" : $("#offline-condition").val(),
					"isOffLine": isOffLine,
					"isExecute": isExecute
				};
			}else{
				if(clickTye == "1"){
					$("button[name='searchBtn-line']").eq(0).addClass("btn-primary").siblings().removeClass("btn-primary");
					$("button[name='searchBtn-status']").eq(0).addClass("btn-primary").siblings().removeClass("btn-primary");
					command_line_flag = "";
					command_status_flag = "";
				}
				offline_flag = "";
				if(command_line_flag == "command_online"){//在线
					isOffLine = "0";
				}else if(command_line_flag == "command_offline"){//离线
					isOffLine = "1";
				}
				if(command_status_flag == "command_success"){//成功
					isExecute = "1";
				}else if(command_status_flag == "command_failed"){//失败
					isExecute = "0";
				}else if(command_status_flag == "command_cancel"){//取消
					isExecute = "4";
				}
				if($("input[name='startTime']").val() && $("input[name='endTime']").val()){
					if(new Date($("input[name='startTime']").val()).getTime() > new Date($("input[name='endTime']").val()).getTime()){
						layer.msg($.i18n.prop("comm.StarttimegtEndtime"));
						return ;
					}
				}
				queryCondition = {
					"currentPage" : pageNo_log_command,
					"pageSize": pageSize_log_command,
					"startTime" :$("input[name='startTime']").val(),
					"endTime" : $("input[name='endTime']").val(),
					"condition" : $("#command-condition").val(),
					"isOffLine": isOffLine,
					"isExecute": isExecute
				};
			}
			...
			if(queryFlag == "offline"){
				queryCondition.currentPage = pageNo_log_offline;
				queryCondition.pageSize = pageSize_log_offline;
			}else{
				queryCondition.currentPage = pageNo_log_command;
				queryCondition.pageSize = pageSize_log_command;
			}
		}
		$.ajax({
			type : 'POST',
			...
			success : function(returnData) {
				...
				if (datas.result && datas.result.length) {
					...
					if(queryFlag == "offline"){
						$('#paging-offline').show();
						$('#markNull-offline').hide();
					}else{
						$('#paging-command').show();
						$('#markNull-command').hide();
					}
				} else {
					if(queryFlag == "offline"){
						$('#markNull-offline').show();
						$('#paging-offline').hide();
					}else{
						$('#markNull-command').show();
						$('#paging-command').hide();
					}
				} 
				if (returnData.code == 0) {
					var templateData = "";
					if(queryFlag == "offline"){
						templateData = {"result":datas.result,"pageNo":pageNo_log_offline,"pageSize":pageSize_log_offline}
						$('#offline-tbody').html(template('offline-logs', templateData));
						tableHeaderAutoWidth("#offlineCommandTableHeader","#offlineCommandTableContent");
					}else{
						templateData = {"result":datas.result,"pageNo":pageNo_log_command,"pageSize":pageSize_log_command}
						$('#command-tbody').html(template('command-logs', templateData));
						 tableHeaderAutoWidth("#commandLogTableHeader","#commandLogTableContent");
					}

// 					checkboxAllSelect("#offlineCommandTableHeader input[type='checkbox']","#offlineCommandTableContent input[type='checkbox']"); //
					checkboxSelectLine("#offlineCommandTableHeader input[type='checkbox']","#offlineCommandTableContent input[type='checkbox']");//选中行背景换色
				}
				if(queryFlag == "offline"){
					totalRecord_log_offline = datas.totalRecord;
					initOffLinelogsPagination(queryCondition);
				}else{
					totalRecord_log_command = datas.totalRecord;
					initCommandlogsPagination(queryCondition);
				}
			}
		});
	}
	...
	var offline_flag = "";//已取消 , 待发送
	var command_line_flag = "";//在线 , 离线
	var command_status_flag = "";//成功 , 失败 , 取消
	
	function btnClick(btnFlag,obj){
		$("#offlineCommandTableHeader input[type='checkbox']").iCheck("uncheck");
		if(btnFlag == 'offline_cancel'){
			$("#offlineCommandTableHeader input[type='checkbox']").iCheck("disable");
		}else{
			$("#offlineCommandTableHeader input[type='checkbox']").iCheck("enable");
		}
		$(obj).addClass("btn-primary").siblings().removeClass("btn-primary");
		var flagArr = btnFlag.split("_");
		if(flagArr[0] == "offline"){
			offline_flag = btnFlag; 
			pageNo_log_offline = 1;
			pageSize_log_offline = 10;
			queryBusinessLog("offline","0");
		}else if(flagArr[0] == "command"){
			pageNo_log_command = 1;
			pageSize_log_command = 10;
			if(flagArr[1].indexOf("line") > -1){
				command_line_flag = btnFlag;
			}else{
				command_status_flag = btnFlag;
			}
			type_flag = btnFlag;
			queryBusinessLog("command","0");
		}
	}
	
	function searchCommand(queryFlag,clickTye){
		if(queryFlag == "offline"){
			pageNo_log_offline = 1;
			//pageSize_log_offline = 10;
		}else{
		...
		queryBusinessLog(queryFlag,clickTye);
	}
	
	function cancelCommand(){
		var ids = [];
		$("#offlineCommandTableContent input[type = 'checkbox']").each(function(i,v){
			if(this.checked){
				ids.push(this.value);
			}
		});
	...
	function initTime(allType){
		$("#createTimeStart_"+allType).focus(function(){
			var start = {
				    elem: '#createTimeStart_'+allType,
				    event: 'focus',
		...
		$("#createTimeEnd_"+allType).focus(function(){
			var end = {
			    elem: '#createTimeEnd_'+allType,
			    event: 'focus',
			    format: "YYYY-MM-DD hh:mm",
			    //min: laydate.now(),
			    max: laydate.now(), //最大日期
	...
	function getTDayTimes(staisType){
		var endTime = $("#createTimeEnd_"+staisType).val();
		if(!endTime){
			var d=new Date(); 
			d.setDate(d.getDate()); 
			...
			$("#createTimeEnd_"+staisType).val(end);
		}
	}
	
	//tab
	tabs(".button_fp", "btn-primary");
	tabs(".button_xf", "btn-primary");

	var totalRecord_fp = 0;
	var pageNo_fp = 1;
	var pageSize_fp = 10;

	var totalRecord_xf = 0;
	var pageNo_xf = 1;
	var pageSize_xf = 10;

	var totalRecord_log = 0;
	var pageNo_log = 1;
	var pageSize_log = 10;
	
	var isOneClick_fp = 1;
	var isOneClick_xf = 1;
	var isOneClick_log = 1;
	$("#businessLogs").one("click",function(){
		initXfFpTime();
		getServiceLog(1,5);
	});
	function initXfFpTime(){
		$("#createTimeStart_fp").val("");
		$("#createTimeStart_xf").val("");
	...
	function set_login_type(login_type,obj){
		$("#login_Code").val(login_type);
		$(obj).addClass("btn-primary").siblings().removeClass("btn-primary");
		searchlogslist_log();
	}
	
	function searchlogslist_log(){
		pageNo_log = 1;
		var startDate = $('#startTime_sport').val();
		var endDate = $('#endTime_sport').val();
		
		var param = {
				"loginAccount":$("#loginAccount_sport").val(),
				"startTime":startDate,
				"endTime":endDate
		};
		if($("#login_Code").val()){
			param.isSuc = $("#login_Code").val();
		}
		initlogslist_log(param);
	}
	
	function initlogslist_log(param){
		if(!param){
			param = {
					
				};
		}
		param.pageSize = pageSize_log;
		param.currentPage = pageNo_log;
		
		$('#noData_log').hide();
		$('#logindata_log').show();
		$('#paging_login_log').hide();
		$('#loginLog-tbody').html("");
		setTimeout(function () { 
			$.ajax({
				type : 'POST',
				url : _ctx + "/userLoginLog/list",
				async : false,
				cache : false,
				data : param,
				success : function(returnData) {
					...
					if(returnData&&returnData.data&&returnData.data.result.length>0){
						var datas = returnData.data;
						datas.pageNo = pageNo_log;
						if (returnData.code == 0) {
							$('#loginLog-tbody').html(template('loginLog-logs', datas));
						}
						totalRecord_log = datas.totalRecord;
						$('#noData_log').hide();
						if(isOneClick_log = 1){
							initpaging_log(param);
							isOneClick_log=0;
						}
						$('#paging_login_log').show();
					}else{
						$('#loginLog-tbody').html("");
						$('#noData_log').show();
						$('#paging_login_log').hide();
	...
	function initpaging_fp(param) {
		$("#paging_fp").pagination({
			prevText : "上一页",
			nextText : "下一页",
			items : totalRecord_fp,
			itemsOnPage : pageSize_fp,
			cssStyle : 'light-theme',
			param:param,
			onPageClick : function(pageNumber,pageSize,param, event) {
				if (event && (event.type=="click" || event.type=="change")) {
					pageNo_fp = pageNumber;
					pageSize_fp = pageSize;
					initlogslist_fp(param);
				}
			},
			onInit : function() {
				$("#paging_fp").pagination("selectPage", pageNo_fp);
			}
		});
	}
	function initpaging_xf(param) {
		$("#paging_xf").pagination({
			prevText : "上一页",
			nextText : "下一页",
			items : totalRecord_xf,
			itemsOnPage : pageSize_xf,
			cssStyle : 'light-theme',
			param:param,
			onPageClick : function(pageNumber,pageSize,param, event) {
				if (event && (event.type=="click" || event.type=="change")) {
					pageNo_xf = pageNumber;
					pageSize_xf = pageSize;
					initlogslist_xf(param);
				}
			},
			onInit : function() {
				$("#paging_xf").pagination("selectPage", pageNo_xf);
			}
		});
	}
	
	function initpaging_log(param){
		$("#paging_login_log").pagination({
			prevText : "上一页",
			nextText : "下一页",
			items : totalRecord_log,
			itemsOnPage : pageSize_log,
			cssStyle : 'light-theme',
			param:param,
			onPageClick : function(pageNumber,pageSize,param, event) {
				if (event && (event.type=="click" || event.type=="change")) {
					pageNo_log = pageNumber;
					pageSize_log = pageSize;
					initlogslist_log(param);
				}
			},
			onInit : function() {
				$("#paging_login_log").pagination("selectPage", pageNo_log);
			}
		});
	}
</script>
<script type="text/html" id="v-info-xf">
	{{each result as xf i}}
<tr>
	<td ><span class="c-f19b04"></span>&nbsp;{{xf.createdAccount}}</span></td>
	<td >{{xf.creationDate}}</td>
	{{if xf.serviceType== 1 }}
		<td >{{xf.account}} / {{xf.imei}}</td>
	{{else}}
		<td >{{xf.imei}}</td>
	{{/if}}
	<td><span title="{{xf.remarks}}">{{xf.remarks}}</span></td>
</tr>
{{/each}}
</script>
<script type="text/html" id="v-info-fp">
	{{each result as xf i}}
<tr>
	<td ><span class="c-f19b04"></span>&nbsp;{{xf.createdAccount}}</span></td>
	<td >{{xf.creationDate}}</td>
