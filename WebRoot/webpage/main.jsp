...
<script src="webpage/resource/js/init_main.js"></script> 
<script type="text/javascript">
...
function setJsLanguage(locale){
	...
	if(locale){
		propertiesObj = {
		    name:"messages", 
			path:"webpage/resource/plugins/i18n/",
		    mode:"both",
		    language:locale, 
		    cache:true,
		    encoding:"UTF-8",
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<div class="navbar-brand">
				<a href="/anhui/customer/customer.html">
		...
		<div class="navbar-collapse collapse">
			...
			<div class="navbar-right p-15 p-b0 ta-r">
				...
				<div class="system-setting">
					<span>您好，<b class="user-name" title="${user-name}">${user-name}</b></span>&emsp;
...
<nav class="menu-seach bc-fff">
	<div class="container-fluid">
		<ul class="nav navbar-nav fs-14">
				<li id="accountCenter"><a href="/anhui/customer/customer.html"><i class="fa fa-newspaper-o" aria-hidden="true"></i>&nbsp;账户中心</a></li>
				<li id="customerManagement"><a href="/anhui/customer/toSearch.html"><i class="fa fa-group"></i>&nbsp;客户管理</a></li>
				<li id="index"><a target="_blank" href="/anhui/index.html"><i class="fa fa-map-o" aria-hidden="true"></i>&nbsp;控制台</a></li>
		</ul>
...
<script type="text/javascript">
	var header_userId = "16341";
	var header_account = <%=request.getParameter("account")%>;
...
function delCookie(name){
	...
	function getUserInfo(oppType){
		/*$.ajax({
			url : "http://127.0.0.1/json/user.json",
			type : "get",
			datatype : "jsonp",
			jsonp:"jsonpcall",
				...
				if(ret.code == 0){
					...
					if(userData){
						if(oppType == "displayUser"){
							...
							//$("#editpwd-form").reset();
							$("#edit-modal-userId").val(userData.id);
							$("#edit-modal-account").val(userData.account);
							
							$("#edit-modal-nickName").val(userData.name);
							$("#edit-modal-nickName").removeClass("error");
							$("label[for='edit-modal-nickName']").remove();
							
							$("#edit-modal-phone").val(userData.phone);
		...
		var ret={
				...
				"data" : {
					...
					"email" : "",
					"enabledFlag" : "1",
					"fullParentId" : "1,12871,13366,12876,12997,16303,",
					"id" : 16341,
					"isBatchSendFM" : "0",
					"isBatchSendIns" : "0",
					"language" : "en",
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="fictitiousAccountForm" class="form-horizontal form-preset  form-ellipsis p-tb25" action="">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label" title="虚拟账号登陆名称">账号登陆名称</label>
                            <div class="col-md-6">
