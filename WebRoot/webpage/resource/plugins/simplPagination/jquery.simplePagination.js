...
(function($){
	...
	var methods = {
		...
		_draw: function() {
			...
			custo_html += '<option value="10">'+$.i18n.prop("page.page10")+'</option>';
			custo_html += '<option value="30">'+$.i18n.prop("page.page30")+'</option>';
			custo_html += '<option value="50">'+$.i18n.prop("page.page50")+'</option>';
			custo_html += '<option value="100">'+$.i18n.prop("page.page100")+'</option>';
			custo_html += '</select>';
			custo_html += '</li>';
		...
		_selectPage: function(pageIndex, event) {
			...
			return o.onPageClick(pageIndex + 1,o.itemsOnPage,o.param, event);
		}
