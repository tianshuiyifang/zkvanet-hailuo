							...
							<div class="map-left-downbox clearfix oy-a">
								<div class="p-10 time-form">
									<form class="form-horizontal form-sm">
										...
										<div class="form-group">
										  <label class="col-sm-4 control-label" title="'开始时间'"> <span class="fl"><span class="c-red">*</span>开始时间:</span></label>
											<div class="col-sm-8 p-l0">
												<input type="text" class="form-control form-control-sm" id="start_Time" onclick="bindChangeDate()" readOnly="true" onblur="date()" placeholder="开始时间" value="">
											</div>
										</div>
										<div class="form-group">
										  <label class="col-sm-4 control-label" title="'结束时间'"> <span class="fl"><span class="c-red">*</span>结束时间:</span></label>
											<div class="col-sm-8 p-l0">
												<input type="text" class="form-control form-control-sm" id="end_Time" onclick="bindChangeDate()" readOnly="true" onblur="date()" placeholder="结束时间" value="">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-12">
...
// 					allMap.setCenter(point);
	...
	function showStopFlag(stopFlagMaker,stopTimeMapIndex){
		...
		var d=new Date(startTime.replace("-","/").replace("-","/")).getTime();
		var d2=new Date(endTime.replace("-","/").replace("-","/")).getTime();
...
<div class="map-popover">
      ...
      <div class="popover-body">
        <table class="tl-f m-tb5">
          <tbody>
			<tr>
			  <th  width="70"   title="开始时间">开始时间：</th>
            ...
            <tr>
              <th class="va-t" title="停留时间">停留时间：</th>
              <td title="{{stopTime}}">{{stopTime}}</td>
            </tr>
          </tbody>
        </table>
      </div>
