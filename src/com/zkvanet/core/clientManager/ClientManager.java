package com.zkvanet.core.clientManager;
...
import com.zkvanet.core.util.EhcacheUtil;
 ...
 * @version 1.0
 */
//add-begin-Author:xugj Date:20160228 for:#859 【分布式改造】目前用户登录session存在class级别缓存导致分布式
public class ClientManager {
	...
	public void addClinet(String sessionId,Client client){
		...
		if(client !=null){
			...
			ret.setUserInfo(client.getUserInfo());
	...
	public Client getClient(String sessionId){
		if(!sessionId.isEmpty()&&ContextHolderUtils.getSession().getAttribute(sessionId)!=null){
